...
import houzz.service.MediationEmailService;
...
public class CheckRestController {
	...
	public String memberIdCheck(@RequestParam(value = "memberId") String memberId) {
	...
	public String medIdCheck(@RequestParam(value = "mediationId") String mediationId) {
	...
	@Autowired
	MediationEmailService mediationEmailService;

	@RequestMapping(value = "/register/mediationMail")
	public String mediationMail(@RequestParam(value = "receiver") String mediationEmail) {
		int i = mediationEmailService.execute(mediationEmail);
		if (i == 1) {
			return "인증이 완료 되었습니다";
		} else {
			return "이미 인증이 되었습니다.";
